...
image=/data/oasis/sub-OAS30002_ses-d0371_acq-TSE_echo-1_T2w.nii.gz
outdir=../tests/results_train2d/oasis_sub-OAS30002_ses-d0371_acq-TSE_echo-1_T2w
...
# kernel=/data/phantom/simu/SUPERRES-ADNIPHANTOM_20200711_PHANTOM-T2-TSE-3D-CORONAL-PRE-ACQ1-01mm_resampled_fwhm-8p0_scale-0p25_len-21_kernel.npy
# 
...
#     -e PYTHONPATH=$psf_est_dir:$sssrlib_dir:$proc_dir:$trainer_dir:$config_dir:$simu_dir \
#     -w $psf_est_dir/scripts -t \
#     psf-est ./train2d.py -i $image -o $outdir -k $kernel -l 31 -na
# 
