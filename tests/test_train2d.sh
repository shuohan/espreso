...
for image in ${images[@]}; do
    for sm in ${smooth[@]}; do
        ...
        outdir=../tests/results_isbi2021/simu_${kernel}_${fwhm}_${scale}_${len}_smooth-${sm}
        ...
        docker run --gpus device=1 --rm \
            ...
            psf-est ./train2d.py -i $image -o $outdir -k $kernel -l 21 -sw $sm -isz 4
    done
done
