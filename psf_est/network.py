...
class KernelNet1d(KernelNet):
    """Estimates the kernel from 1D patches.
    ...
    def forward(self, x):
        return F.conv1d(x, self.kernel_cuda)


class KernelNet2d(KernelNet):
    """Estimates the kernel from 2D patches.
...
class LowResDiscriminator1d(LowResDiscriminator):
